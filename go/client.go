...
const (
	baseURL        = "https://api.apiverve.com/v1/dnslookup"
	defaultTimeout = 30 * time.Second
)

// Client is the DNS Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new DNS Lookup API client.
...
// Execute makes a request to the DNS Lookup API with typed parameters.
//
