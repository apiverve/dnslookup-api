/*
 * DNS Lookup API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the DNS Lookup API.
 * API Documentation: https://docs.apiverve.com/ref/dnslookup
 */
...
namespace APIVerve.Examples
{
    class DNSLookupExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/dnslookup";

        /// <summary>
        /// Make a GET request to the DNS Lookup API
        /// </summary>
        static async Task<JsonDocument> CallDNSLookupAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling DNS Lookup API...\n");

            var result = await CallDNSLookupAPI();
