...
```gradle
dependencies {
    implementation 'com.github.apiverve:dnslookup-api:1.1.14'
}
```
...
```java
import com.apiverve.dnslookup.DNSLookupAPIClient;
import com.apiverve.dnslookup.APIResponse;
import com.apiverve.dnslookup.APIException;

// Initialize the client
DNSLookupAPIClient client = new DNSLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dnslookup](https://docs.apiverve.com/ref/dnslookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/dnslookup](https://docs.apiverve.com/ref/dnslookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dnslookup-api/issues)
