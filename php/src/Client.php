 ...
 * ```
 *
 * @see https://dnslookup.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dnslookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DnslookupClient] {$message}\n";
        }
    }
}
